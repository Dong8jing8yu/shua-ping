...
while True:
 ...
 choice = input("\033[4m\033[36m东经雨\033[0m-\033[34m请选择要执行的轰炸-\033[4m\033[36m东经雨\033[0m(1-信息，2-倒计时):")

 if choice == "1":
     messages = input("\033[33m请输入你要轰炸的信息:\033[0m")
     times = eval(input("(\033[31m注意:中途无法暂停!!!\033[0m)\033[33m请输入你要轰炸的次数:\033[0m"))
     ...
     print("\033[1m\033[31m感谢使用\033[4m\033[36m东经雨\033[0m\033[1m\033[31m编写的简易脚本，再见\033[0m")
     time.sleep(4)
 if choice == "2":

     ft = input("\033[4m\033[36m东经雨\033[0m-\033[34m请选择要执行的轰炸-\033[4m\033[36m东经雨\033[0m(1-倒数，2-正数):")

     Qmessages = input("\033[33m请输入你要轰炸的信息(数字前半部分):\033[0m")
     Hmessages = input("\033[33m请输入你要轰炸的信息(数字后半部分):\033[0m")
     times = eval(input("(\033[31m注意:中途无法暂停!!!\033[0m)\033[33m请输入你要轰炸的次数(注意是从0开始或结束):\033[0m"))
     speed = eval(input("\033[33m速度/秒:\033[0m"))
     print("请将光标移动至会话框,你只有5秒时间")
     for i in range(5):
         print("\033[34m距离信息轰炸还需要\033[32m%d\033[0m秒" % (5 - i))
